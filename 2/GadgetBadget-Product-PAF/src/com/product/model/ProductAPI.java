...
public class ProductAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String outputString = productObj.insertItem(request.getParameter("productCode"),
				request.getParameter("productName"), request.getParameter("productPrice"), request.getParameter("productDesc"));
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response)
		...
		String outputString = productObj.updateItem(
	...
	protected void doDelete(HttpServletRequest request, HttpServletResponse response)
		...
		Map paras = getParasMap(request);
		String output = productObj.deleteItem(paras.get("productID").toString());
