...
<body style="background-color: #f0f0f0">
	...
	<nav class="navbar navbar-expand-lg navbar-dark fixed-top bg-dark">
		<a class="navbar-brand" href="#">GadgetBadgetShop</a>
		...
		<div class="collapse navbar-collapse" id="navbarCollapse">
			<ul class="navbar-nav mr-auto sidenav" id="navAccordion">
				...
				<li class="nav-item ml-3"><a class="nav-link" href="#">Payment Details</a></li>
				<li class="nav-item ml-3"><a class="nav-link" href="#">FundingBody Details</a></li>
	...
	<footer class="footer bg-dark">
		<div class="container">
			<div class="text-center text-light">
				<span>Create by , <span style="color: #87CEEB;">PAF Team 04</span>
